...
`StatementParser` uses Stanford CoreNLP dependency parsing to extract subject–predicate–object structures generically. It falls back to simple pattern rules when parsing fails.
